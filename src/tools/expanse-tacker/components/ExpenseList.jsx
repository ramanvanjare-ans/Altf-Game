    ...
    <div className="w-full">
      <div className="flex justify-between items-center mb-4">
        ...
        <select
          ...
          className="px-3 py-1 rounded-md border bg-(--background) border-(--border)focus:outline-none focus:ring-2 focus:ring-expense-light focus:border-transparent"
        >
      ...
      {sortedExpenses.length === 0 ? (
        <div className="bg-(--card) rounded-lg shadow-sm p-8 text-center text-(--foreground)">
