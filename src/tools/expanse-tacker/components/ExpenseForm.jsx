...
const ExpenseForm = () => {
  ...
  return (
    <div className="bg-(--card) rounded-lg shadow-md p-6 w-full max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full  text-white py-2  rounded-md  bg-[#2563eb]  transition-all cursor-pointer"
          disabled={isSubmitting}
        >
